					...
					<div class="tab-pane fade show active" id="orders-all" role="tabpanel" aria-labelledby="orders-all-tab">
						<div class="app-card app-card-orders-table shadow-sm mb-5">
							<div class="app-card-body">
								<div class="p-3">
									<a class="btn btn-primary btn-sm text-white" href="create.php" role="button">Add Teacher </a>
								</div>
								<div class="table-responsive">
									...
									if(isset($_GET['sms'])){
										...
										if($sms=='deleted'){
											echo '<div class="alert alert-success">Teachers deleted successfully</div>';
										...
										<tbody>
											...
											$i=1;
											 while($data=mysqli_fetch_array($select_result)){
												?>
												<tr>
												<td class="cell"><?php echo $data['faculty_id']?></td>
