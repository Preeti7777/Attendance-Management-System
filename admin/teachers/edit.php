                    ...
                    <div class="col-12 col-md-6">
                        <div class="app-card app-card-settings shadow-sm p-4">
                            ...
                            <div class="app-card-body">
                                ...
                                if(isset($_GET['id'])){
                                    $id=$_GET['id'];
                                    $select ="SELECT * FROM teachers WHERE faculty_id=$id";
                                ...
                                if (isset($_POST['save'])) {
                                    ...
                                    if ($name == "" || $phone == "" || $address == "" || $email == "" || $faculty_id == "") {
                                        ...
                                        $sql = "UPDATE teachers SET faculty_id='$faculty_id', name='$name', phone='$phone', address='$address', email='$email' WHERE faculty_id=$id";
