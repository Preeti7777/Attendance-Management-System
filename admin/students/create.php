                            ...
                            <div class="app-card-body">
                                ...
                                <form class="settings-form" method="POST" enctype="multipart/form-data">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="reg_id" class="form-control" id="setting-input-1" value="">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="faculty" class="form-control" id="setting-input-1" value="">
                                    </div>
                                    <div class="mb-3">
                                        <label for="setting-input-1" class="form-label">Batch</label>
                                        <input type="text" name="batch" class="form-control" id="setting-input-1" value="">
                                    </div>
                                    <div class="mb-3">
                                        <label for="setting-input-1" class="form-label"> Parent Name</label>
                                        <input type="text" name="parent_name" class="form-control" id="setting-input-1" value="">
                                    </div>
                                    <div class="mb-3">
                                        <label for="setting-input-1" class="form-label">Parent Contact</label>
                                        <input type="text" name="parent_phone" class="form-control" id="setting-input-1" value="">
                                    </div>
